...
const Item = () => {
  const desc =
    "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Verolabore laboriosam exercitationem suscipit quidem, expedita quo quosofficia quibusdam consectetur recusandae molestiae id fuga, quas deleniti natus alias commodi voluptatibus.";
  ...
  return (
    <div className="Item w-1/3 h-[25vh] p-[0.25rem]">
      <div className="w-full h-full border border-gray-500 rounded-md bg-gray-950 py-3 px-4 flex flex-col justify-between overflow-hidden">
        <div className="upper">
        ...
        <div className="lower">
          <p className="date text-ms mb-1">2024-11-07</p>
